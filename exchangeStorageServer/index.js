        ...
        if (data.type === "response") {
            ...
            if (data.responseTo === "height") {
                ...
                if (globalHeight < localHeight) {
                    ...
                    client.send(JSON.stringify({ request: "specific-height", coin: data.meta.coin, height: localHeight, nextBlock: true }));
                } else {
                    syncing = false;
                }
                ...
                let cell = table["_" + (Math.ceil(writeHeight / 6000000000) * 6000000000).toString()];
                if (cell) {
                    ...
                    await updateDocument(data.meta.coin.toLowerCase(), "table", {
                        ["_" + (Math.ceil(writeHeight / 6000000000) * 6000000000).toString()]: newChunk._id
                    })
                }
                // starting the second recursive request
                client.send(JSON.stringify({ request: "height", coin: data.meta.coin }));
            }
