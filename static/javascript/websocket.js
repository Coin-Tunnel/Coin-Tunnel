...
var event;
  ...
  function next() {
    event = new EventSource("/sse/prices/all?slow=true");

    event.onmessage = function (event) {
      data = JSON.parse(event.data)

      document.getElementById("footbtcprice").innerText = data.btc + " USD";

      document.getElementById("footethprice").innerText = data.eth + " USD";

      document.getElementById("footltcprice").innerText = data.ltc + " USD";

      document.getElementById("footxrpprice").innerText = data.xrp + " USD";
    }
  }